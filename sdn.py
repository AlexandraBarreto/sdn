...
def myNetwork():
    ...
    info( '*** Add switches\n')
    s15 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s14 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s13 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s12 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s11 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s10 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s9 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s8 = net.addSwitch('s3', cls=OVSKernelSwitch)
    s7 = net.addSwitch('s3', cls=OVSKernelSwitch)
